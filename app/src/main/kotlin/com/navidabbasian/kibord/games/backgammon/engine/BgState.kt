...
data class BgState(
    ...
    /**
     * قانون ایرانیِ «زننده تک می‌ماند»: خانه‌ای (از دید بازیکنِ نوبت) که مهره‌ی
     * زننده‌ی داخل خانه‌ی خودی همین نوبت رویش نشسته — تا پایان نوبت روی خانه‌ی
     * پرِ خودی نمی‌رود. پایان نوبت پاک می‌شود و برای شبکه و ادامه‌ی بازی
     * سریالایز می‌شود. در روش‌های دیگر همیشه تهی است.
     */
    val homeHitLockRel: Int? = null,
