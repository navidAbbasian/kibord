...
/** یک بازیِ تخته‌نرد پیداشده در شبکه */
data class BgDiscoveredGame(
    val hostName: String,
    val address: String,
    val port: Int,
)
...
/**
 * ثبت و کشف بازی تخته‌نرد روی شبکه‌ی محلی — میزبان سرویس را ثبت می‌کند و
 * مهمان‌ها خودکار پیدایش می‌کنند. همه‌ی callback ها روی نخ اصلی می‌آیند.
 */
class BgNsd(context: Context) {
    ...
    companion object {
        ...
        const val SERVICE_NAME_PREFIX = "backgammon-"
