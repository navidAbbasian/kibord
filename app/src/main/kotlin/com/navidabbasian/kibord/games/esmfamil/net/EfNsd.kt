...
/** یک بازیِ پیداشده در شبکه */
data class EfDiscoveredGame(
    val hostName: String,
    val address: String,
    val port: Int,
)
...
/**
 * ثبت و کشف بازی روی شبکه‌ی محلی — میزبان سرویس را ثبت می‌کند و
 * مهمان‌ها خودکار پیدایش می‌کنند. همه‌ی callback ها روی نخ اصلی می‌آیند.
 */
class EfNsd(context: Context) {
    ...
    companion object {
        ...
        const val SERVICE_NAME_PREFIX = "esmfamil-"
