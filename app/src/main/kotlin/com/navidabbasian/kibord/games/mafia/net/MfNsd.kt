...
/** یک بازیِ مافیای پیداشده در شبکه */
data class MfDiscoveredGame(
    val hostName: String,
    val address: String,
    val port: Int,
)
...
/**
 * ثبت و کشف بازی مافیا روی شبکه‌ی محلی — میزبان سرویس را ثبت می‌کند و
 * مهمان‌ها خودکار پیدایش می‌کنند. همه‌ی callback ها روی نخ اصلی می‌آیند.
 */
class MfNsd(context: Context) {
    ...
    companion object {
        ...
        const val SERVICE_NAME_PREFIX = "mafia-"
