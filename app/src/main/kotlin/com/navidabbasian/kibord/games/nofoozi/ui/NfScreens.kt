...
/** کارتِ «بازی نیمه‌کاره داری» روی صفحه‌ی ورود */
@Composable
private fun NfResumeCard(
    code: String,
    wasHost: Boolean,
    busy: Boolean,
    onResume: () -> Unit,
...
/** بنرِ کوچکِ «میزبان لحظه‌ای قطع شده» — روی همه‌ی صفحه‌های داخل بازیِ مهمان */
@Composable
fun NfHostAwayBanner(modifier: Modifier = Modifier) {
    Row(
        modifier = modifier
