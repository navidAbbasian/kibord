...
/** یک بازیِ من کی‌امِ پیداشده در شبکه */
data class WaDiscoveredGame(
    val hostName: String,
    val address: String,
    val port: Int,
)
...
/**
 * ثبت و کشف بازی من کی‌ام روی شبکه‌ی محلی — میزبان سرویس را ثبت می‌کند و
 * مهمان‌ها خودکار پیدایش می‌کنند. همه‌ی callback ها روی نخ اصلی می‌آیند.
 */
class WaNsd(context: Context) {
    ...
    companion object {
        ...
        const val SERVICE_NAME_PREFIX = "whoami-"
