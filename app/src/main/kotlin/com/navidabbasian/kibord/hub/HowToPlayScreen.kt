...
val gameGuides = listOf(
    ...
    GameGuide(
        gameId = "backgammon",
        steps = listOf(
            "انتخاب روش" to "اول یکی از سه روش رو انتخاب کنید: تخته‌نرد کلاسیک، تخته‌نرد هلندی یا هایپرگامون.",
            ...
            "کی برد؟" to "هرکی زودتر همه‌ی مهره‌هاش رو خارج کنه برنده‌ست: تکی ۱ امتیاز، مارس ۲ امتیاز و مارس کامل ۳ امتیاز!",
        ),
        tips = listOf(
    ...
    GameGuide(
        gameId = "hokm",
        steps = listOf(
            "تنظیمات" to "اسمت رو بنویس، بگو چند نفره بازی می‌کنی (۴ نفره دو تیمه، ۳ نفره هرکی برای خودش، ۲ نفره تک‌به‌تک) و تا چند امتیاز بازی بره.",
        ...
        tips = listOf(
            ...
            "تو ۳ نفره ۲ خشت از دسته بیرونه و هر نفر ۱۷ کارت داره؛ تو ۲ نفره نصف دسته اصلاً بازی نمی‌شه، پس هیچ کارتی «مطمئن» نیست!",
