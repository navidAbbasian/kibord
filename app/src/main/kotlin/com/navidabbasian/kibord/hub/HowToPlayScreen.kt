...
private val guides = listOf(
    ...
    GameGuide(
        gameId = "who_am_i",
        steps = listOf(
            "جمع بشید" to "تعداد بازیکن‌ها رو انتخاب کنید و اسم‌ها رو بنویسید — نوبتی بازی می‌کنید.",
            "یکی برات می‌نویسه" to "نفر بعدی مخفیانه اسم یه آدم معروف (یا یکی از جمع!) رو برات می‌نویسه.",
            "بذار رو پیشونی!" to "گوشی افقی می‌شه؛ عرضی بذارش روی پیشونیت تا همه ببینن کی هستی — جز خودت!",
            "سوال بپرس" to "با سوال‌های بله/نه بفهم کی هستی: «زنده‌ام؟»، «ورزشکارم؟»، «ایرانی‌ام؟»",
            "حدس بزن" to "فهمیدی؟ بگو و گوشی رو به جلو خم کن ✅ — حدس درست ۱ امتیاز داره.",
            "بررسی امتیاز" to "بعد از هر نوبت، جمع می‌تونه امتیاز رو کم و زیاد کنه؛ آخرش «کی برد؟» رو بزنید.",
        ),
        tips = listOf(
