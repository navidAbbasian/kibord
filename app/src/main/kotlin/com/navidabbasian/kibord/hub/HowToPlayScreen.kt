...
private val guides = listOf(
    ...
    GameGuide(
        ...
        steps = listOf(
            ...
            "نتیجه" to "آخر وقت می‌بینی چند تا درست گفتی و کدوم کلمه‌ها رد شدن.",
        ),
        tips = listOf(
    ...
    GameGuide(
        gameId = "shah_dozd",
        steps = listOf(
            "جمع بشید" to "۴ تا ۸ نفر؛ اسم‌ها رو بنویسید تا قرعه‌کشی شروع بشه.",
            "نقش مخفی" to "گوشی دست‌به‌دست می‌چرخه و هر کی مخفیانه نقشش رو می‌بینه: شاه 👑، وزیر 🎩، دزد 🦹 و بقیه رعیت.",
            "شاه فرمان می‌ده" to "شاه خودش رو معرفی می‌کنه و فرمان می‌ده: «وزیر، دزد رو پیدا کن!» وزیر هم خودش رو معرفی می‌کنه.",
            "وزیر حدس می‌زنه" to "وزیر از بین بقیه یک نفر رو به عنوان دزد انتخاب می‌کنه.",
            "امتیازها" to "شاه ۱۰۰ می‌گیره. وزیر درست حدس بزنه ۸۰؛ اشتباه بزنه، دزدِ زرنگ ۸۰ می‌گیره! رعیت‌ها ۵۰.",
            "کی برد؟" to "بعد از ۵ راند، بیشترین مجموع امتیاز برنده‌ست.",
        ),
        tips = listOf(
            "دزد باید عادی رفتار کنه — هر خنده‌ی بی‌جا لو می‌ده!",
            "وزیر می‌تونه قبل از حدس، از بقیه سوال بپرسه و قیافه‌ها رو بخونه.",
        ),
    ),
    GameGuide(
        gameId = "proverb",
        steps = listOf(
            ...
            "نصفش رو بخون" to "گوشی دست گوینده‌ست: نیمه‌ی اول ضرب‌المثل رو بلند می‌خونه — جوابش هم فقط برای خودش روی کارته.",
