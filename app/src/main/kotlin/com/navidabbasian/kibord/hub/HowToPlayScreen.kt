...
val gameGuides = listOf(
    ...
    GameGuide(
        ...
        steps = listOf(
            ...
            "ساعت شخصی ⏱️" to "هر نفر ۹۰ ثانیه ذخیره داره. فقط وقتی نوبتته ساعتت کم می‌شه — مثل ساعت شطرنج!",
            ...
            "پاس" to "حرفِ سختی افتاد؟ با دکمه‌ی پاس حرف عوض می‌شه ولی ۱ ثانیه جریمه می‌خوری.",
